...
public class BusinessForgetActivity extends AppCompatActivity {
        ...
        tvGetCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tvphone.getText().toString().length()!=11){
                    Toast.makeText(BusinessForgetActivity.this,"请输入正确的手机号码",Toast.LENGTH_LONG).show();
                }else{
                    ...
                    categoryBmobQuery.findObjects(new FindListener<MyUser>() {
                        ...
                        public void done(List<MyUser> object, BmobException e) {
                            if (e == null&&object.size()==0) {
                                Toast.makeText(BusinessForgetActivity.this, "该账户未注册" , Toast.LENGTH_LONG).show();
                            } else if(e==null&&object.size()!=0) {
                                if(object.get(0).getType().equals("0")){
                                    Toast.makeText(BusinessForgetActivity.this, "该账户为用户账户，请在用户页面修改密码" , Toast.LENGTH_LONG).show();
                                }else{
                                    timedown.start();
                                    ...
                                    BmobSMS.requestSMSCode(phone,"", new QueryListener<Integer>() {
                                        ...
                                        public void done(Integer smsId, BmobException e) {
                                            if (e == null) {
                                                Toast.makeText(BusinessForgetActivity.this,"发送验证码成功" ,Toast.LENGTH_LONG).show();
                                            } else {
                                                Toast.makeText(BusinessForgetActivity.this,"发送验证码失败（" + e.getErrorCode() + "-" + e.getMessage() + "）\n",Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    });
                                }
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(phone.length()!=11||code==""||newPassword.length()<6){
                    Toast.makeText(BusinessForgetActivity.this, "请输入完整验证码与密码", Toast.LENGTH_SHORT).show();
                }else {
                    if (reset.getText().toString() == "使用该账户登陆") {
                        LoadingUtil.Loading_show(BusinessForgetActivity.this);
                        ...
                        user.login(new SaveListener<MyUser>() {
                            ...
                            public void done(MyUser bmobUser, BmobException e) {
                                if (e == null) {
                                    ...
                                    Toast.makeText(BusinessForgetActivity.this, "登录成功", Toast.LENGTH_LONG).show();
                                    String account=user.getUsername();
                                    String pwd=newPassword;
                                    SharedPreferencesUtil nS;
                                    nS=new SharedPreferencesUtil(BusinessForgetActivity.this,"user");
                                    nS.setValue("account",account);
                                    nS.setValue("pwd",pwd);
                                    nS.setValue("type","1");
                                    Intent intent =new Intent(BusinessForgetActivity.this, MainBusinessActivity.class)
                                    ...
                                    LoadingUtil.Loading_close();
                                    Toast.makeText(BusinessForgetActivity.this, "登录失败（" + e.getMessage()+"）", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    } else {
                                ...
                                if (e == null) {
                                    ...
                                    handler = new Handler(){
                                        ...
                                        public void handleMessage(Message msg) {
                                            if (msg.what == 111) {
                                                LoadingUtil.Loading_close();
                                                Toast.makeText(BusinessForgetActivity.this, "重置成功！", Toast.LENGTH_SHORT).show();
                                                reset.setText("使用该账户登陆");
                                            }else if(msg.what==222){
                                                LoadingUtil.Loading_close();
                                                Toast.makeText(BusinessForgetActivity.this, "更改失败，后端错误", Toast.LENGTH_SHORT).show();

                                            }else if(msg.what==333){
                                                LoadingUtil.Loading_close();
                                                Toast.makeText(BusinessForgetActivity.this, "更改失败，连接失败", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    };
                                    ...
                                    Toast.makeText(BusinessForgetActivity.this, "重置成功", Toast.LENGTH_LONG).show();
                                    reset.setText("使用该账户登陆");
                                } else {
                                    LoadingUtil.Loading_close();
                                    Toast.makeText(BusinessForgetActivity.this, "验证码错误（" + e.getErrorCode() + "-" + e.getMessage()+"）", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    }
